...
SelectorByCloseToCloseVolatility.cs
Copyright (C) 2003 
Marco Milletti
...
{
  /// <summary>
  /// Class for selection on tickers by close to close volatility
  /// </summary>
   public class SelectorByCloseToCloseVolatility : TickerSelector, ITickerSelector
  {
        
    
    public SelectorByCloseToCloseVolatility(DataTable setOfTickersToBeSelected, 
                               bool orderInASCmode,
                                         ...
                                         maxNumOfReturnedTickers)
    {
     ...
     public SelectorByCloseToCloseVolatility(string groupID, 
                                bool orderInASCmode,
                                DateTime firstQuoteDate,
                                DateTime lastQuoteDate,
                                long maxNumOfReturnedTickers):
