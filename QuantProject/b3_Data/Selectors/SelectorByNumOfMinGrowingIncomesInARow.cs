...
namespace QuantProject.Data.Selectors
{
  ...
  /// minimum incomes, always growing, previously than a given date
  /// </summary>
   public class SelectorByNumOfMinGrowingIncomesInARow : TickerSelector , ITickerSelector
  {
    ...
    public SelectorByNumOfMinGrowingIncomesInARow(DataTable setOfTickersToBeSelected, 
                                         ...
                                         500)
    {
      ...
      this.numDaysForFundamentalDataAvailability = 
		 ...
		 private bool getTableOfSelectedTickers_areIncomesAllGreaterThanMinimum(DataTable incomesForTicker)
		 {
		 		...
		 		double currentIncome = this.minimumIncome;
