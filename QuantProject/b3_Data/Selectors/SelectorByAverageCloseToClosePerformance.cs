...
SelectorByAverageCloseToClosePerformance.cs
Copyright (C) 2003 
Marco Milletti
...
{
  /// <summary>
  /// Class for selection on tickers by average close to close performance
  /// </summary>
   public class SelectorByAverageCloseToClosePerformance : TickerSelector , ITickerSelector
  {
        
    
    public SelectorByAverageCloseToClosePerformance(DataTable setOfTickersToBeSelected, 
                               bool orderInASCmode,
                                         ...
                                         maxNumOfReturnedTickers)
    {
     ...
     public SelectorByAverageCloseToClosePerformance(string groupID, 
                                bool orderInASCmode,
                                DateTime firstQuoteDate,
                                DateTime lastQuoteDate,
                                long maxNumOfReturnedTickers):
