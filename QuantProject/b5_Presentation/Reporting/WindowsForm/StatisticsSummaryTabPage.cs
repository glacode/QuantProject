...
{
	/// <summary>
	/// TabPage to show a summary of statistics of various type within the report form
	/// </summary>
	[Serializable]
	public class StatisticsSummaryTabPage : TabPage
	{
...
//			label.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		...
		{
			Object ob = propertyInfo.GetValue( this.accountReport.StatisticsSummary , null );
			if ( ob is SummaryRow )
			{
		...
		{
			if(this.accountReport.StatisticsSummary != null)
			//if the StatisticsSummary has been created or deserialized
				foreach ( PropertyInfo summaryProperty in
									this.accountReport.StatisticsSummary.GetType().GetProperties() )
		...
		public StatisticsSummaryTabPage( AccountReport accountReport )
		{
			this.accountReport = accountReport;
			this.summaryRow = new SummaryRow();
			this.myInitializeComponent();
			this.Text = "StatisticsSummary";
