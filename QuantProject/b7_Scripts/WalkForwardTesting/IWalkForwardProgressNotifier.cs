...
IWalkForwardProgressNotifier.cs
Copyright (C) 2004 
Glauco Siliprandi
...
namespace QuantProject.Scripts.WalkForwardTesting
{
	...
	/// </summary>
	public interface IWalkForwardProgressNotifier
	{
		event NewProgressEventHandler InSampleNewProgress;
		event NewProgressEventHandler OutOfSampleNewProgress;
	}
}
