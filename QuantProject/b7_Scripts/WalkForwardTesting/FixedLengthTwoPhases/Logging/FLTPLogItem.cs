...
{
	/// <summary>
	/// Log item for the Fixed Length Two Phases strategy
	/// </summary>
	[Serializable]
	public class FLTPLogItem : LogItem
	{
		private TesterForFLTPTestingPositions[]
