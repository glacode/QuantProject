...
{
	/// <summary>
	/// TestingPositions for the Fixed Length Two Phases strategy
	/// </summary>
	[Serializable]
	public class FLTPTestingPositions :
		TestingPositions , IGeneticallyOptimizable
	{
		...
		// FLTPTestingPositions type to undecodables
		public FLTPTestingPositions() : base()
		{
		}


		public FLTPTestingPositions(
