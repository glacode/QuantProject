...
DecoderForFLTPTestingPositionsWithBalancedWeights.cs
Copyright (C) 2008
Glauco Siliprandi
...
namespace QuantProject.Scripts.WalkForwardTesting.FixedLengthTwoPhases
{
	...
	{
		public DecoderForFLTPTestingPositionsWithBalancedWeights()
		{
		}

		protected override TestingPositions getMeaningForUndecodable()
		{
			return new FLTPTestingPositions();
		}
		...
		protected override TestingPositions getTestingPositions(double[] weights, string[] tickers)
		{
			...
			FLTPTestingPositions fLTPTestingPositions =
				new FLTPTestingPositions( weightedPositions );
			return fLTPTestingPositions;
		}
	}
}
