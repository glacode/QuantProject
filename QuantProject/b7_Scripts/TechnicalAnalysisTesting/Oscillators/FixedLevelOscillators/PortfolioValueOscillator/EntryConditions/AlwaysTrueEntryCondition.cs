...
{
	/// <summary>
	/// Description of AlwaysTrueEntryCondition.
	/// </summary>
	[Serializable]
	public class AlwaysTrueEntryCondition : IEntryCondition
	{
	
		public AlwaysTrueEntryCondition()
		{
		}
