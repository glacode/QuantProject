...
{
  /// <summary>
  /// LogItem for the PVO_CTO strategy
  /// portfolio value oscillator strategy
  /// </summary>
  [Serializable]
  public class PVO_CTOLogItem : PVOLogItem
  {
		
		public PVO_CTOLogItem(EndOfDayDateTime endOfDayDateTime,
		...
		protected override void runStrategyClickEventHandler(object sender, System.EventArgs e)
		{
			...
			PVO_CTOStrategy strategy =
				new PVO_CTOStrategy(eligiblesSelector,
