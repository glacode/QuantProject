...
namespace QuantProject.Scripts.TechnicalAnalysisTesting.Oscillators.FixedLevelOscillators.PortfolioValueOscillator.BiasedPVO.BiasedPVONoThresholds
{
	...
	/// has the highest gain or loss
	/// </summary>
	[Serializable]
	public class RunBiasedPVONoThresholds : RunPVO
	{
    private int numOfDifferentGenomesToEvaluateOutOfSample;
    private double minimumAcceptableGain;
    
    public RunBiasedPVONoThresholds(string tickerGroupID, int maxNumOfEligibleTickersForOptimization, 
      ...
      this.scriptName = "PVO_PriceSel_NoWeightsAndThresholds";
		}
    ...
    {
      this.endOfDayTimerHandler = new EndOfDayTimerHandlerBiasedPVONoThresholds(this.tickerGroupID, this.numberOfEligibleTickers,
