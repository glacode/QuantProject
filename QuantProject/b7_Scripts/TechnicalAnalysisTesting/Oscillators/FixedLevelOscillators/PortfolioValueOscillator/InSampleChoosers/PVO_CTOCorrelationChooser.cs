...
{
	/// <summary>
	/// PVO_CTOCorrelationChooser to be used for
	...
	/// </summary>
	public class PVO_CTOCorrelationChooser : PVOCorrelationChooser
	{
		...
		/// </param>
		public PVO_CTOCorrelationChooser(int numberOfBestTestingPositionsToBeReturned,
																		...
																		IntervalsType.CloseToOpenIntervals,
																		benchmark)
		{
			...
			ReturnsManager returnsManager)
		{
			this.correlationProvider = 
				new CloseToOpenCorrelationProvider(eligibleTickers.Tickers, returnsManager,
