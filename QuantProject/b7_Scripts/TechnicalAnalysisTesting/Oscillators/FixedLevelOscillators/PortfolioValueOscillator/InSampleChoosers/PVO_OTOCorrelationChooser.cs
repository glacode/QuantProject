...
namespace QuantProject.Scripts.TechnicalAnalysisTesting.Oscillators.FixedLevelOscillators.PortfolioValueOscillator.InSampleChoosers
{
	...
	/// <summary>
	/// PVO_OTOCorrelationChooser to be used for
	...
	/// </summary>
	public class PVO_OTOCorrelationChooser : PVOCorrelationChooser
	{
		...
		/// </param>
		public PVO_OTOCorrelationChooser(int numberOfBestTestingPositionsToBeReturned,
																		 int openToOpenReturnIntervalLength,
																		 ...
																		 base(numberOfBestTestingPositionsToBeReturned,
			     															  openToOpenReturnIntervalLength,
																					maxCorrelationValue,
																					balancedWeightsOnVolatilityBase,
																					IntervalsType.OpenToOpenIntervals,
																				  benchmark)
		{
			...
			ReturnsManager returnsManager)
		{
			...
			this.correlationProvider =
				new OpenToOpenCorrelationProvider(eligibleTickers.Tickers, firstDate,
				                                  ...
				                                  minimumAbsoluteReturnValue,
				                                  maximumAbsoluteReturnValue,
				                                  this.benchmark);
		}
	}
}
