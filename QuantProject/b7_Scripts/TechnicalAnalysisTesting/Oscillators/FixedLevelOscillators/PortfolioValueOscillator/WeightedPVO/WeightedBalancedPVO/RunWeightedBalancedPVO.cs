...
namespace QuantProject.Scripts.TechnicalAnalysisTesting.Oscillators.FixedLevelOscillators.PortfolioValueOscillator.WeightedPVO.WeightedBalancedPVO
{
	...
	/// </summary>
	[Serializable]
	public class RunWeightedBalancedPVO : RunEfficientPortfolio
	{
    ...
    public RunWeightedBalancedPVO(string tickerGroupID, int maxNumOfEligibleTickersForOptimization, 
		...
		{
      this.ScriptName = "PVO_SR_BalancedWeights_PriceSel";
    ...
    {
      this.endOfDayTimerHandler = new EndOfDayTimerHandlerWeightedBalancedPVO(this.tickerGroupID, this.numberOfEligibleTickers,
