...
EndOfDayTimerHandlerWeightedPVO.cs
Copyright (C) 2006 
Marco Milletti
...
namespace QuantProject.Scripts.TechnicalAnalysisTesting.Oscillators.FixedLevelOscillators.PortfolioValueOscillator.WeightedPVO
{
  ...
  /// Oscillator using weights for tickers
  /// </summary>
  [Serializable]
  public class EndOfDayTimerHandlerWeightedPVO : EndOfDayTimerHandlerPVO
  {
            
    public EndOfDayTimerHandlerWeightedPVO(string tickerGroupID, int numberOfEligibleTickers, 
...
//      
      ...
      bool setGenomeCounter)
    {
      ...
      {
        this.iGenomeManager =
          new GenomeManagerWeightedPVO(setOfTickersToBeOptimized,
