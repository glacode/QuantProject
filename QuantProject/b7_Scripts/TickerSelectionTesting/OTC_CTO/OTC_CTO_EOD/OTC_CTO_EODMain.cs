...
{
	/// <summary>
	/// Entry point for the OTC_CTO_EODMain. If any strategy
...
//			this.benchmark = new Benchmark( "CCE" );
			...
			this.lastDateTime = new DateTime( 2008 , 12, 31 );
...
//			
				= new OTC_CTO_EODStrategy(eligiblesSelector ,
...
//				new DateTime(2009,9,1), new DateTime(2009,8,28) );
		...
		{
			string backTestId = "OTC_CTO_EODStrategy";
			IAccountProvider accountProvider;
			accountProvider =	new SimpleAccountProvider();
//			accountProvider =	
//				new FixedCommissionsAndSlippageAccountProvider(5.0, 0.0);
...
//		}
		...
		protected override string getFullPathFileNameForMain()
		{
			...
			string fullPathFileNameForMainAtHome = 
				@"C:\Quant\QuantProject\b7_Scripts\TickerSelectionTesting\OTC_CTO\OTC_CTO_EOD\OTC_CTO_EODMain.cs";
			if( File.Exists(fullPathFileNameForMainAtHome) )
				returnValue = fullPathFileNameForMainAtHome;
			else
				returnValue = 
					@"C:\Utente\MarcoVarie\Vari\qP\QuantProject\b7_Scripts\TickerSelectionTesting\OTC_CTO\OTC_CTO_EOD\OTC_CTO_EODMain.cs";
