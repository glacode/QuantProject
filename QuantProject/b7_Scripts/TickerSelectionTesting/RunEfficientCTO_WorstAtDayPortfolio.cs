...
RunEfficientCTOPorfolio_WorstAtDay.cs
Copyright (C) 2003 
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.EfficientPortfolios
{
	...
	/// </summary>
  [Serializable]
  public class RunEfficientCTOPortfolio_WorstAtDay : RunEfficientPortfolio
  {
    protected int numDaysBetweenEachOptimization;
    protected int numOfGenomesForOTCScanning;
    public RunEfficientCTOPortfolio_WorstAtDay(string tickerGroupID, int numberOfEligibleTickers, 
    ...
    {
      this.ScriptName = "CTOWorstAtDay_NoCoeff_SharpeOTCCTO";
    ...
    {
      this.endOfDayTimerHandler = new EndOfDayTimerHandlerCTO_WorstAtDay(this.tickerGroupID,
                                          ...
                                          this.numOfGenomesForOTCScanning);
    }
