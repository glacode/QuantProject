...
RunEfficientOTCPorfolioMultiday.cs
Copyright (C) 2003 
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.EfficientPortfolios
{
	...
	/// </summary>
  [Serializable]
  public class RunEfficientOTCPortfolioMultiday : RunEfficientPortfolio
  {
    protected int numDaysBetweenEachOptimization;	
    public RunEfficientOTCPortfolioMultiday(string tickerGroupID, int numberOfEligibleTickers, 
    ...
    */
    ...
    {
      this.endOfDayTimerHandler = new EndOfDayTimerHandlerOTCMultiday(this.tickerGroupID,
