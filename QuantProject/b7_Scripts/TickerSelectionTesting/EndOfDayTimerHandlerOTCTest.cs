...
EndOfDayTimerHandlerOTCTest.cs
Copyright (C) 2003 
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.EfficientPortfolios
{
  ...
  /// </summary>
  [Serializable]
  public class EndOfDayTimerHandlerOTCTest : EndOfDayTimerHandlerOTC
  {
    private static bool optimized;
       
    public EndOfDayTimerHandlerOTCTest(string tickerGroupID, int numberOfEligibleTickers, 
                                      ...
                                      bool setGenomeCounter)
    {
      ...
      if(!EndOfDayTimerHandlerOTCTest.optimized)
    	{
        base.setTickers(currentDate.AddDays(this.numDaysForOptimizationPeriod),
                        true);
	      EndOfDayTimerHandlerOTCTest.optimized = true;
	   	}
    }
		
    public void Reset()
    {
      EndOfDayTimerHandlerOTCTest.optimized = false;
    }
