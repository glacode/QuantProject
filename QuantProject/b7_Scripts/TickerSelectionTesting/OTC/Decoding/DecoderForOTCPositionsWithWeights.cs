...
DecoderForOTCPositionsWithWeights.cs
Copyright (C) 2009
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.OTC 
{
	...
	/// OTCPositions with weights
	/// </summary>
	[Serializable]
	public class DecoderForOTCPositionsWithWeights : DecoderForTestingPositionsWithWeights
	{
		
		public DecoderForOTCPositionsWithWeights() : base()
		{
		}
