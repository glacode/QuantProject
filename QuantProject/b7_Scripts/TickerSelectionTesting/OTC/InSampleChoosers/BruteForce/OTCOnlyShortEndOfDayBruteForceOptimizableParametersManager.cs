...
OTCOnlyShortEndOfDayBruteForceOptimizableParametersManager.cs
Copyright (C) 2009
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.OTC.InSampleChoosers.BruteForce
{
	...
	/// </summary>
	[Serializable]
	public class OTCOnlyShortEndOfDayBruteForceOptimizableParametersManager :
		CombinationBasedBruteForceOptimizableParametersManager
	{
		...
		public OTCOnlyShortEndOfDayBruteForceOptimizableParametersManager(
