...
OTCEndOfDayBruteForceOptimizableParametersManager.cs
Copyright (C) 2009
Marco Milletti
...
namespace QuantProject.Scripts.TickerSelectionTesting.OTC.InSampleChoosers.BruteForce
{
	...
	/// </summary>
	[Serializable]
	public class OTCEndOfDayBruteForceOptimizableParametersManager :
		CombinationBasedBruteForceOptimizableParametersManager
	{
		...
		public OTCEndOfDayBruteForceOptimizableParametersManager(
