...
namespace QuantProject.Scripts.TickerSelectionTesting.OTC.InSampleChoosers.Genetic
{
	...
	/// </summary>
	[Serializable]
	public class OTCEndOfDayGeneticChooser : GeneticChooser
	{
    protected GenomeManagerType genomeManagerType;
    	
		public OTCEndOfDayGeneticChooser(
		...
		{
			return new GenomeManagerForOTC_EndOfDay(eligibleTickers, this.numberOfPortfolioPositions,
