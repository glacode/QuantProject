...
TestLinearRegressionWithoutCovarianceMatrix.cs
Copyright (C) 2010
Glauco Siliprandi
...
namespace QuantTesting.ADT.Econometrics
{
	[TestFixture]
	/// <summary>
	/// Test for the class QuantProject.ADT.Econometrics.LinearRegressionWithoutCovarianceMatrix
	/// </summary>
	public class TestLinearRegressionWithoutCovarianceMatrix
	{
		[Test]
...
//			double[] weights = new double[] { 1 , 1 , 1 , 1 };
			...
			LinearRegressionWithoutCovarianceMatrix linearRegression = new LinearRegressionWithoutCovarianceMatrix();
