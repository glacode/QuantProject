...
ByPriceLessLiquidAlwaysIntradayQuoted.cs
Copyright (C) 2009
Marco Milletti
...
namespace QuantProject.Business.Strategies.Eligibles
{
	...
	/// -step 2: from tickers selected by step 1, the less liquid
	...
	/// </summary>
	[Serializable]
	public class ByPriceLessLiquidAlwaysIntradayQuoted : IEligiblesSelector
	{
		...
		public string Description
		{
			get{
				return "From_" + this.tickersGroupID + " (temporized: " +
					...
					"Less Liquid and Always intraday quoted at each market day (MSFT) for the in sample time frame";
			}
		}
				
		public ByPriceLessLiquidAlwaysIntradayQuoted(
