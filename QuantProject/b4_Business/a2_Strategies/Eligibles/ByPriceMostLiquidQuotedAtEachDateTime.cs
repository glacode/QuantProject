...
ByPriceMostLiquidQuotedAtEachDateTime.cs
Copyright (C) 2008
Marco Milletti
...
namespace QuantProject.Business.Strategies.Eligibles
{
	...
	/// always quoted at all given market dateTimes are selected (not more than a given max number);
	/// </summary>
	[Serializable]
	public class ByPriceMostLiquidQuotedAtEachDateTime : IEligiblesSelector
	{
		...
		public ByPriceMostLiquidQuotedAtEachDateTime(
...
//			dataSet.WriteXml( "c:\\qpReports\\pairsTrading\\eligiblesCon_ByPriceMostLiquidAlwaysQuoted.xml" );
      ...
      DataTable dataTableToBeReturned =
				quotedAtPercOfDateTimesFromLastSelection.GetTableOfSelectedTickers();
