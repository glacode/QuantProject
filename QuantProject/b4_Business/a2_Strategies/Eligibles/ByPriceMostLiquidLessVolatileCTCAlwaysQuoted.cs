...
ByPriceMostLiquidLessVolatileCTCAlwaysQuoted.cs
Copyright (C) 2008
Marco Milletti
...
namespace QuantProject.Business.Strategies.Eligibles
{
	...
	public class ByPriceMostLiquidLessVolatileCTCAlwaysQuoted : IEligiblesSelector
	{
		...
		{
			get{
				return "ByPriceMostLiquidLessVolatileCTCAlwaysQuoted";
			}
		}
			...
			double minPrice, double maxPrice)
		{
			...
			this.byPriceMostLiquidLessVolatileCTCAlwaysQuoted_checkParameters();
		}
