...
ByPriceMostLiquidLessVolatileCTOAlwaysQuoted.cs
Copyright (C) 2008
Marco Milletti
...
namespace QuantProject.Business.Strategies.Eligibles
{
	...
	/// less volatile (CTO returns in the last
	...
	/// (not more than maxNumberOfEligibleTickersToBeChosen);
	/// </summary>
	public class ByPriceMostLiquidLessVolatileCTOAlwaysQuoted : IEligiblesSelector
	{
		...
		{
			get{
				return "ByPriceMostLiquidLessVolatileCTOAlwaysQuoted";
			}
		}
		
		private void byPriceMostLiquidLessVolatileCTOAlwaysQuoted_checkParameters()
		{
		...
		public ByPriceMostLiquidLessVolatileCTOAlwaysQuoted(
		 	...
		 	double minPrice, double maxPrice)
		{
			...
			this.byPriceMostLiquidLessVolatileCTOAlwaysQuoted_checkParameters();
		}
      ...
      SelectorByCloseToOpenVolatility lessVolatileSelector =
				new SelectorByCloseToOpenVolatility( dataTableMostLiquid ,
...
//			dataSet.WriteXml( "c:\\qpReports\\pairsTrading\\eligiblesCon_ByPriceMostLiquidLessVolatileCTOAlwaysQuoted.xml" );
