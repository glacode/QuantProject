...
namespace QuantProject.Business.Financial.Accounting.Commissions
{
	...
	/// </summary>
	[Serializable]
  public class FixedCommission : Commission
	{
  	...
  	public override double Value
		{
			get
			{
				...
				if  ( ( this.transaction.Type == TransactionType.AddCash ) ||
					...
					returnValue = this.fixedCommission;
				
				return returnValue;
			}
		}
		public FixedCommission( Transaction transaction, double fixedCommission ) : base( transaction )
		{
