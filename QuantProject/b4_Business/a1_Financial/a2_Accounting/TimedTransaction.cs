...
namespace QuantProject.Business.Financial.Accounting
{
	...
	/// <summary>
	/// Summary description for TimedTransaction.
	/// </summary>
  [Serializable]
  public class TimedTransaction : Transaction
  {
    ...
    public TimedTransaction( TransactionType transactionType , Double transactionAmount ,
    ...
    public TimedTransaction( TransactionType transactionType , Instrument instrument ,
      long quantity , double instrumentPrice , ExtendedDateTime extendedDateTime )
    ...
    public override string ToString()
    {
      return
        base.ToString() +
        "\n   DateTime: " + this.extendedDateTime.ToString();
    }
  }
}
