...
AverageReturnOnMondayWithOpenPositions.cs
Copyright (C) 2008 
Marco Milletti
...
namespace QuantProject.Business.Financial.Accounting.Reporting.StatisticsSummaryRows
{
	...
	/// </summary>
	[Serializable]
	public class AverageReturnOnMondayWithOpenPositions : AverageReturnOnDayOfWeekWithOpenPositions
	{
		public AverageReturnOnMondayWithOpenPositions( StatisticsSummary statisticsSummary )
		...
		{
			return "Average % return on Monday (with opened positions)";
		}
