...
{
	/// <summary>
	/// Summary row containing the Expectancy Score calculation for
	/// the account report equity line
	/// </summary>
	[Serializable]
  public class ExpectancyScore : DoubleSummaryRow
	{
		private ArrayList getReturns( EquityLine equityLine )
		{
		...
		public ExpectancyScore( EquityLine equityLine ) : base( 6 )
		{
      this.rowDescription = "Expectancy Score";
			ICollection returns = equityLine.GetReturns().Values;
			this.rowValue = AdvancedFunctions.GetExpectancyScore(
				returns );
    }
	}
}
