...
namespace QuantProject.Applications.Downloader
{
	...
	public class TickerGroupsViewer : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem menuItemPasteSelectedTickers;
		...
		private void InitializeComponent()
		{
			...
			this.menuItemPasteSelectedTickers = new System.Windows.Forms.MenuItem();
			...
			this.listViewGroupsAndTickers.ContextMenu = this.contextMenuTickerGroupsListView;
			...
			this.contextMenuTickerGroupsListView.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																											...
																											this.menuItemPasteSelectedTickers,
																											this.menuItem1});
			// 
			...
			this.menuItemValidateGroup.Click += new System.EventHandler(this.menuItemValidateGroup_Click);
			// 
			...
			this.menuItemDownloadQuotesOfCurrentGroup.Click += new System.EventHandler(this.menuItemDownloadQuotesOfCurrentGroup_Click);
			// 
			...
			// 
			// menuItemPasteSelectedTickers
			// 
			this.menuItemPasteSelectedTickers.Index = 3;
			this.menuItemPasteSelectedTickers.Text = "&Paste Tickers";
			this.menuItemPasteSelectedTickers.Click += new System.EventHandler(this.menuItemPasteSelectedTickers_Click);
			// 
			// menuItem1
			// 
			this.menuItem1.Index = 4;
			this.menuItem1.Text = "&Remove selected Items";
			// 
			// TickerGroupsViewer
			// 
		...
		private void menuItemPasteSelectedTickers_Click(object sender, System.EventArgs e)
		{
			try
			{
				//initialize table of tickers to be copied  
				IDataObject iDataObject = Clipboard.GetDataObject();
				DataTable tickers = (DataTable)iDataObject.GetData(DataFormats.Serializable);
				// some checks are performed
				if(tickers == null)
				{
					MessageBox.Show("No ticker has been copied to ClipBoard!\n\n" +
					"Select some tickers before trying again!",
					"Paste operation fail", MessageBoxButtons.OK,
		...
		private void menuItemDownloadQuotesOfCurrentGroup_Click(object sender, System.EventArgs e)
		{
			...
			if(tableOfSelectedTickers.Rows.Count == 0)
			{
				MessageBox.Show("No ticker has been selected!\n\n" + 
					"Select some tickers or groups containing tickers!", "QuantDownloader error message",
					MessageBoxButtons.OK, MessageBoxIcon.Error);
				return;
			}
		...
		private void menuItemValidateGroup_Click(object sender, System.EventArgs e)
		{
			DataTable tableOfSelectedTickers = this.GetTableOfSelectedTickers();
			if(tableOfSelectedTickers.Rows.Count == 0)
			{
